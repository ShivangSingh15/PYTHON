...
# and import messagebox as mb from tkinter to print final result
from tkinter import messagebox as mb

# import json to use json file for data given by upgrad
import json
...
class Quiz:
    ...
    def display_result(self):
        ...
        # Shows a message box to display the result using message box from tkinter
...
with open("C:\\Users\\shiva\\Downloads\\data.json") as q:
    data = json.load(q)
